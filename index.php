...
// if(strpos( $ip , "178.176" ) === 0 || strpos( $ip , "31.173" ) === 0 || strpos( $ip , "213.141" ) === 0  || strpos( $ip , "188.162" ) === 0 || strpos( $ip , "188.170" ) === 0 || strpos( $ip , "176.59" ) === 0 || strpos( $ip , "188.170" ) === 0)
   // {	
    ...
    // }
// }
// if ( $_SERVER["HTTP_HOST"] != "cashzz-playzz-avtomatyzz.azurewebsites.net" ) {
...
$new_url = 'mycash-play-avtomaty.com';
//########
...
// $ref_json = json_decode(file_get_contents( 'https://shop.perteq.ru/5.json'));
...
curl_close( $ch );
$bodytag = str_replace( "((?!mycash-play-avtomaty\.com/b)\w+(?:\.\w+)+", "https://cashzz-playzz-avtomatyzz.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "cashzz-playzz-avtomatyzz.azurewebsites.net", $contents );
...
// if ( file_exists( $cachefile ) ) {
	...
	// jQuery(document).ready(function($) {
		...
		// jQuery.post( "https://mycash-play-avtomaty.com/cash.php", data, function(response) {
			// if(response == 0){
