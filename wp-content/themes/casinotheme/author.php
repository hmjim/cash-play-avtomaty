...
get_header(); ?>
	...
	<section id="cpa_primary" class="cpa_site-content">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="cpa_archive-header">
				<h1 class="cpa_archive-title"><?php printf( __( 'Author Archives: %s', 'casinotheme' ), '<span class="cpa_vcard"><a class="cpa_url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
