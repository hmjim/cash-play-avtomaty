        ...
        <div class="cpa_one_block_cont bra3">
            <div class="cpa_block_lefton">
                <div class="cpa_blt">
                    ...
                    <div class="cpa_bltb">
                        <a href="<?php echo get_post_permalink(); ?>" class="cpa_but_d" title="Демо-игра <?php the_title(); ?>">Демо-игра</a>
                        <a href="<?php the_field('link_game_pay'); ?>" title="Играть на реальные деньги" class="cpa_but_c">На деньги</a>
                    </div>
                </div>
                <div class="cpa_blb">
